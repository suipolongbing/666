	...
	export class CardDeckData {
		...
		*/
		...
		private SaveStartCardData()//存开始的牌，用来重来一次
		{
			...
			// 	console.log('SaveStartCardList1', JSON.stringify(this.cardListKeep));
			// }
		}
		...
		public setKeepCardList(cardListKeep) {
		...
		public connectDearCardArrayToRender(index: number, sortEndHandle?: Laya.Handler) {
			...
			console.log('vGroupData.pokerList2 ', this.pokerLineList[i].data);
		}
