...
* name;
*/
var ShopPTableView = /** @class */ (function (_super) {
    __extends(ShopPTableView, _super);
    function ShopPTableView() {
        ...
        _this.LastzOrder = 0;
        _this.LastParent = null;
        _this.init();
        _this.addFourCardZero();
        _this.initStartDeck();
        _this.initBrodcast();
        return _this;
    }
    ShopPTableView.prototype.onShow = function (bool, villageId) {
        if (bool) {
            this.visible = true;
    ...
    ShopPTableView.prototype.init = function () {
        this.startCard = this.getChildByName('PokerTable').getChildByName('StartCard');
        this.threeCard = this.getChildByName('PokerTable').getChildByName('ThreeCard');
        this.deckCard1 = this.getChildByName('PokerTable').getChildByName('Deck1');
        this.deckCard2 = this.getChildByName('PokerTable').getChildByName('Deck2');
        this.deckCard3 = this.getChildByName('PokerTable').getChildByName('Deck3');
        this.deckCard4 = this.getChildByName('PokerTable').getChildByName('Deck4');
        this.buildCard1 = this.getChildByName('PokerTable').getChildByName('Build1');
        this.buildCard2 = this.getChildByName('PokerTable').getChildByName('Build2');
        this.buildCard3 = this.getChildByName('PokerTable').getChildByName('Build3');
        this.buildCard4 = this.getChildByName('PokerTable').getChildByName('Build4');
        ...
        this.threeList = new Array();
        this.four1List = new Array();
        this.four2List = new Array();
        this.four3List = new Array();
        this.four4List = new Array();
    };
    ShopPTableView.prototype.initCoin = function () {
        this.earncoin.text = '' + Xconfig.HeroCoin;
        this.costcoin.text = '' + Xconfig.FaPaiBaseCostList[Xconfig.LastVillageId - 1].baseCoin;
    };
    ShopPTableView.prototype.initStartDeck = function () {
        this.buildList = [];
        for (var i = 0; i < Xconfig.StartBuildDeckNum; i++) {
            var num = GameMain.app.getRandom(1, Xconfig.BuildMaxType);
    ...
    ShopPTableView.prototype.initBuildDeck = function (id) {
            ...
            if (Xconfig.villageData[i].villageId == id) {
                ...
                if (this.vg.villageBuildCount == 4) {
                    if (this.vg.villageCard.length <= 0) {
                        var weapon1 = WeaponCard.create(this.buildCard1, Xconfig.WeaponMaxType[this.vg.villageBuild[0]]);
                        var weapon2 = WeaponCard.create(this.buildCard2, Xconfig.WeaponMaxType[this.vg.villageBuild[1]]);
                        var weapon3 = WeaponCard.create(this.buildCard3, Xconfig.WeaponMaxType[this.vg.villageBuild[2]]);
                        var weapon4 = WeaponCard.create(this.buildCard4, Xconfig.WeaponMaxType[this.vg.villageBuild[3]]);
    ...
    ShopPTableView.prototype.addFourCardZero = function () {
        if (this.four1List.length <= 0 && this.four2List.length <= 0 && this.four3List.length <= 0 && this.four4List.length <= 0) {
            var pokerRd1 = new BuildRender();
            var pokerRd2 = new BuildRender();
            var pokerRd3 = new BuildRender();
            var pokerRd4 = new BuildRender();
    ...
    ShopPTableView.prototype.addBuildList = function () {
    ...
    ShopPTableView.prototype.addEvent = function () {
        //翻牌
        this.startCard.on(Laya.Event.MOUSE_DOWN, this, this.FanPai);
    };
    ShopPTableView.prototype.initBrodcast = function () {
    ...
    ShopPTableView.prototype.addBuildClick = function (img) {
    ...
    ShopPTableView.prototype.addDeckClick = function (img) {
    ...
    ShopPTableView.prototype.checkBuildClick = function () {
        for (var i = 0; i < this.threeList.length; i++) {
            console.log('addDeckClick1:', this.threeList[i], i, this.threeCard.getChildAt(i));
            var img = this.threeCard.getChildAt(i);
    ...
    ShopPTableView.prototype.checkDeckClick = function () {
        for (var i = 0; i < this.four1List.length; i++) {
            console.log('addDeckClick2:', this.four1List[i], i, this.deckCard1.getChildAt(i + 1));
            var img = this.deckCard1.getChildAt(i + 1);
        ...
        for (var i = 0; i < this.four2List.length; i++) {
            var img = this.deckCard2.getChildAt(i + 1);
        ...
        for (var i = 0; i < this.four3List.length; i++) {
            var img = this.deckCard3.getChildAt(i + 1);
        ...
        for (var i = 0; i < this.four4List.length; i++) {
            var img = this.deckCard4.getChildAt(i + 1);
    ...
    ShopPTableView.prototype.removeBuildClick = function (img) {
    ...
    ShopPTableView.prototype.removeDeckClick = function (img) {
    ...
    ShopPTableView.prototype.removeEvent = function () {
        this.startCard.off(Laya.Event.MOUSE_DOWN, this, this.FanPai);
    };
    ShopPTableView.prototype.Dispose = function () {
        this.removeSelf();
        this.destroy();
    };
    ShopPTableView.prototype.FanPai = function () {
        ...
        var card = this.buildList[this.buildList.length - 1];
    ...
    ShopPTableView.prototype.Calculate = function (n) {
        var count = 1;
        while (n > 0) {
    ...
    //1-开始牌堆卡牌移动结束处理
    ShopPTableView.prototype.MoveAniEnd = function (type) {
        switch (type) {
            case 1:
    ...
    ShopPTableView.prototype.SortAndMoveToPos = function () {
    ...
    ShopPTableView.prototype.imgBuildHandler = function (e, target) {
        if (e == 1) {
            console.log('down');
    ...
    ShopPTableView.prototype.imgDeckHandler = function (e, target) {
        if (e == 1) {
            console.log('down2');
            this.IsStartDraging = true;
            this.IsStartDragMoved = false;
    ...
    ShopPTableView.prototype.checkCollsion = function (img) {
        var imgAnX = img.x + img.width / 2;
        var imgAnY = img.y + img.height / 2;
    ...
    ShopPTableView.prototype.dealCollsion = function (img) {
        var _this = this;
        var imgAnX = img.x + img.width / 2;
        var imgAnY = img.y + img.height / 2;
        if (this.deckBox1.contains(imgAnX, imgAnY)) {
            if (this.four1List.length > 0) {
                Laya.Tween.to(img, { x: this.DragMovingStartPos.x, y: this.DragMovingStartPos.y }, 200, Laya.Ease.sineOut, new Laya.Handler(this, function () {
                    _this.threeCard.addChild(img);
                    img.pos(_this.DragMovingStartPos.x - _this.threeCard.x, _this.DragMovingStartPos.y - _this.threeCard.y);
                }), 0);
                return;
            }
            ...
            img.pos(0, 0);
            var poker_1 = this.threeList[this.threeList.length - 1];
            this.threeList.splice(this.threeList.length - 1, 1);
            this.four1List.push(poker_1);
            this.SortAndMoveToPos();
            this.removeBuildClick(img);
            this.checkBuildClick();
            this.checkDeckClick();
            ...
            img.pos(0, 0);
            var poker_2 = this.threeList[this.threeList.length - 1];
            this.threeList.splice(this.threeList.length - 1, 1);
            this.four2List.push(poker_2);
            this.SortAndMoveToPos();
            this.removeBuildClick(img);
            this.checkBuildClick();
            this.checkDeckClick();
            ...
            img.pos(0, 0);
            var poker_3 = this.threeList[this.threeList.length - 1];
            this.threeList.splice(this.threeList.length - 1, 1);
            this.four3List.push(poker_3);
            this.SortAndMoveToPos();
            this.removeBuildClick(img);
            this.checkBuildClick();
            this.checkDeckClick();
            ...
            img.pos(0, 0);
            var poker_4 = this.threeList[this.threeList.length - 1];
            this.threeList.splice(this.threeList.length - 1, 1);
            this.four4List.push(poker_4);
            this.SortAndMoveToPos();
            this.removeBuildClick(img);
            this.checkBuildClick();
            this.checkDeckClick();
            ...
            var poker_5 = this.threeList[this.threeList.length - 1];
            this.threeList.splice(this.threeList.length - 1, 1);
            var coin = Number(Xconfig.GetMetPrice(poker_5.data.mType));
            this.earnCoin(coin);
            this.SortAndMoveToPos();
            this.removeBuildClick(img);
            this.checkBuildClick();
    ...
    ShopPTableView.prototype.dealMoveClickEvent = function (img) {
        var _this = this;
        if (!img) {
            return;
        }
        if (this.four1List.length <= 0) {
            Laya.Tween.to(img, { x: this.deckCard1.x, y: this.deckCard1.y }, 150, Laya.Ease.sineIn, new Laya.Handler(this, function () {
                _this.deckCard1.addChild(img);
                img.pos(0, 0);
                var poker = _this.threeList[_this.threeList.length - 1];
                _this.threeList.splice(_this.threeList.length - 1, 1);
                _this.four1List.push(poker);
                _this.SortAndMoveToPos();
                _this.removeBuildClick(img);
                _this.checkBuildClick();
                _this.checkDeckClick();
            }), 0);
        }
        else if (this.four2List.length <= 0) {
            Laya.Tween.to(img, { x: this.deckCard2.x, y: this.deckCard2.y }, 150, Laya.Ease.sineIn, new Laya.Handler(this, function () {
                _this.deckCard2.addChild(img);
                img.pos(0, 0);
                var poker = _this.threeList[_this.threeList.length - 1];
                _this.threeList.splice(_this.threeList.length - 1, 1);
                _this.four2List.push(poker);
                _this.SortAndMoveToPos();
                _this.removeBuildClick(img);
                _this.checkBuildClick();
                _this.checkDeckClick();
            ...
            Laya.Tween.to(img, { x: this.deckCard3.x, y: this.deckCard3.y }, 150, Laya.Ease.sineIn, new Laya.Handler(this, function () {
                _this.deckCard3.addChild(img);
                img.pos(0, 0);
                var poker = _this.threeList[_this.threeList.length - 1];
                _this.threeList.splice(_this.threeList.length - 1, 1);
                _this.four3List.push(poker);
                _this.SortAndMoveToPos();
                _this.removeBuildClick(img);
                _this.checkBuildClick();
                _this.checkDeckClick();
            ...
            Laya.Tween.to(img, { x: this.deckCard4.x, y: this.deckCard4.y }, 150, Laya.Ease.sineIn, new Laya.Handler(this, function () {
                _this.deckCard4.addChild(img);
                img.pos(0, 0);
                var poker = _this.threeList[_this.threeList.length - 1];
                _this.threeList.splice(_this.threeList.length - 1, 1);
                _this.four4List.push(poker);
                _this.SortAndMoveToPos();
                _this.removeBuildClick(img);
                _this.checkBuildClick();
                _this.checkDeckClick();
    ...
    ShopPTableView.prototype.deal2MoveClickEvent = function (img) {
        this.LastParent.addChild(img);
        img.pos(0, 0);
    };
    ShopPTableView.prototype.deal2Collsion = function (img) {
        var imgAnX = img.x + img.width / 2;
        var imgAnY = img.y + img.height / 2;
        if (this.buildBox1.contains(imgAnX, imgAnY)) {
            ...
            var poker_6;
            if (this.LastParent == this.deckCard1) {
                poker_6 = this.four1List[this.four1List.length - 1];
                this.four1List.splice(this.four1List.length - 1, 1);
            }
            else if (this.LastParent == this.deckCard2) {
                poker_6 = this.four2List[this.four2List.length - 1];
                this.four2List.splice(this.four2List.length - 1, 1);
            }
            else if (this.LastParent == this.deckCard3) {
                poker_6 = this.four3List[this.four3List.length - 1];
                this.four3List.splice(this.four3List.length - 1, 1);
            }
            else if (this.LastParent == this.deckCard4) {
                poker_6 = this.four4List[this.four4List.length - 1];
                this.four4List.splice(this.four4List.length - 1, 1);
            }
            var coin = Number(Xconfig.GetMetPrice(poker_6.data.mType));
            this.earnCoin(coin);
            poker_6.Dispose();
        }
        else {
    ...
    ShopPTableView.prototype.deal2Of1 = function (img) {
        var _this = this;
        Laya.Tween.to(img, { x: this.DragMovingStartPos.x, y: this.DragMovingStartPos.y }, 200, Laya.Ease.sineOut, new Laya.Handler(this, function () {
            _this.LastParent.addChild(img);
            img.pos(_this.DragMovingStartPos.x - _this.LastParent.x, _this.DragMovingStartPos.y - _this.LastParent.y);
        }), 0);
    };
    ShopPTableView.prototype.deal2Of2 = function (img, type, num) {
        var poker;
        var weacard;
        if (num == 1) {
            weacard = this.buildCard1.getChildAt(0);
        }
        else if (num == 2) {
            weacard = this.buildCard2.getChildAt(0);
        }
        else if (num == 3) {
            weacard = this.buildCard3.getChildAt(0);
        }
        else if (num == 4) {
            weacard = this.buildCard4.getChildAt(0);
        }
        var mat = weacard.weaponType.material;
        if (type == 1) {
            poker = this.four1List[this.four1List.length - 1];
            if (mat.indexOf(poker.data.mType) != -1) {
                var isCollect = weacard.CheckMaterialRight(poker.data.mType);
                if (isCollect) {
                    poker.Dispose();
                    this.four1List.splice(this.four1List.length - 1, 1);
                }
    ...
    ShopPTableView.prototype.costCoin = function (num) {
        Xconfig.HeroCoin -= num;
        this.earncoin.text = '' + Xconfig.HeroCoin;
    };
    ShopPTableView.prototype.earnCoin = function (num) {
        Xconfig.HeroCoin += num;
        this.earncoin.text = '' + Xconfig.HeroCoin;
    };
    ShopPTableView.prototype.upCoin = function (num) {
        Xconfig.FaPaiBaseCostList[Xconfig.LastVillageId - 1].baseCoin = num;
        this.costcoin.text = '' + Xconfig.FaPaiBaseCostList[Xconfig.LastVillageId - 1].baseCoin;
    };
    ShopPTableView.prototype.finishCard = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        this.earnCoin(args[0]);
        var ss = GameMain.app.viewManager.sceneMap.completion2Array[Xconfig.LastVillageId - 1];
        var ss2 = GameMain.app.viewManager.sceneMap.completion3Array[Xconfig.LastVillageId - 1];
        var ss3 = GameMain.app.viewManager.sceneMap.completionArray[Xconfig.LastVillageId - 1];
        var num = Number(ss.text);
        var num2 = Number(ss2.text);
        num -= 1;
        num2 += 1;
        ss.text = num + '';
        ss2.text = num2 + '';
        ...
        if (args[1] != 0) {
            var y4 = false;
            for (var i = 0; i < this.vg.villageCard.length; i++) {
    ...
    ShopPTableView.prototype.checkWeaponCardStyle = function (id) {
        var ss = GameMain.app.viewManager.sceneMap.completionArray[Xconfig.LastVillageId - 1];
        ss.visible = true;
    };
    return ShopPTableView;
}(ui.shopPTableUI));
//# sourceMappingURL=ShopPTableView.js.map