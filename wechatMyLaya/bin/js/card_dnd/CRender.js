...
var CRender = /** @class */ (function () {
    function CRender() {
        ...
        this.Txt2FileName = "";
        this.Txt3FileName = "";
        this.cardType = CRenderType.cardIMG; //卡片图类型
    ...
    CRender.prototype.Dispose = function () {
        if (this.img) {
            this.img.removeSelf();
            this.img.dispose();
            this.img = null;
    ...
    CRender.prototype.ChangeRenderToSystemCard = function (systemImgName) {
    ...
    CRender.prototype.ChangeRenderByData = function (data) {
        if (data.IsCardBack) {
    ...
    CRender.prototype.onCardBackIMGLoaded = function () {
    ...
    CRender.prototype.onLoadedCardIMG = function () {
    ...
    CRender.prototype.onLoadedSystemIMG = function () {
    ...
    CRender.GetImgFileNameWithTypeNum = function (type, no) {
        var data = new CData(type, no);
        return CRender.GetImgFileName(data);
    };
    CRender.GetImgFileName = function (data) {
        var typeStr = "";
        switch (data.mType) {
            case CType.Enemy:
    ...
    CRender.GetTxt1FileName = function (data) {
        var tRet = "" + CConfig.GetT1Desc(data.mType, data.mNo);
        return tRet;
    };
    CRender.GetTxt2FileName = function (data) {
        var tRet = "" + CConfig.GetT2Name(data.mType, data.mNo);
        return tRet;
    };
    CRender.GetTxt3FileName = function (data) {
        var tRet = "" + CConfig.GetT3Hp(data.mType, data.mNo);
        return tRet;
    };
    CRender.prototype.SetAtk = function (data, value) {
        data.SetAtk(value);
        var tRet = "" + data.mAtk;
        return tRet;
    };
    CRender.prototype.SetHp = function (data, value) {
        data.SetHp(value);
        var tRet = "" + data.mHp;
        this.Txt3FileName = tRet;
    };
    CRender.prototype.SetShield = function (data, value) {
        data.SetShield(value);
        var tRet = "" + data.mShield;
        return tRet;
    };
    CRender.backSkinName = "back.png";
    CRender.cardSkinName = "card_img.png";
    return CRender;
}());
var CRenderType;
(function (CRenderType) {
    CRenderType[CRenderType["cardIMG"] = 0] = "cardIMG";
    CRenderType[CRenderType["cardBack"] = 1] = "cardBack";
    CRenderType[CRenderType["systemIMG"] = 2] = "systemIMG"; //系统图案
})(CRenderType || (CRenderType = {}));
//# sourceMappingURL=CRender.js.map